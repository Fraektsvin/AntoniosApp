...
public class HorizontalDottedAnimation extends View {
        ...
        public HorizontalDottedAnimation(Context context, AttributeSet attrs) {
            super(context, attrs);
        }

        public HorizontalDottedAnimation(Context context, AttributeSet attrs, int defStyleAttr) {
